#!/usr/bin/env python3
"""Batch rename CGameSprite sub_ functions (round 3 - arcane spell failure)."""
import re
...
replacements = {
    "sub_724270": "GetShieldArcaneFailure",
    "sub_724360": "GetArmorArcaneFailure",
    "sub_724430": "GetArcaneSpellFailure",
}
