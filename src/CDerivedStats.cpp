...
void CDerivedStats::Reload(CGameSprite* pSprite, CCreatureFileHeader* pCreature, CGameSpriteSpells* pSpells, CGameSpriteGroupedSpellList* pDomainSpells)
{
    ...
    m_nACDexBonus = 0;
    m_nACDodgeBonus = 0;
    m_nACDeflectionBonus = pCreature->wm_field_3E;
...
CDerivedStats& CDerivedStats::operator=(const CDerivedStats& other)
{
    ...
    m_nACDexBonus = other.m_nACDexBonus;
    ...
    m_cImmunitiesItemEquipAlt = other.m_cImmunitiesItemEquipAlt;
    m_cImmunitiesItemTypeEquipAlt = other.m_cImmunitiesItemTypeEquipAlt;
    ...
    m_cImmunitiesProjectile = other.m_cImmunitiesProjectile;
    m_cBounceProjectileAlt = other.m_cBounceProjectileAlt;
    m_cImmunitiesProjectileAlt = other.m_cImmunitiesProjectileAlt;
    m_cBounceProjectileLevelDec = other.m_cBounceProjectileLevelDec;
    ...
    // m_cImmunitiesSpell = other.m_cImmunitiesSpell;
    // m_cBounceSpell = other.m_cBounceSpell;
    // m_cImmunitiesSchool = other.m_cImmunitiesSchool;
    // m_cImmunitiesSecondaryType = other.m_cImmunitiesSecondaryType;
...
void CDerivedStats::Unmarshal(BYTE* pStats, LONG nStats)
{
    ...
    m_nACDexBonus = pTemplate->m_nACDexBonus;
