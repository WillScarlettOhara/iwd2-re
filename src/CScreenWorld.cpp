...
void CScreenWorld::StartDeath()
{
    ...
    SetActionPanelActive(FALSE, TRUE);
...
// 0x693710
void CScreenWorld::SetChatKeyboardFocus()
{
    CUIPanel* pPanel;
...
// 0x695570
void CScreenWorld::SetActionPanelActive(BOOL bActive, BOOL bInvalidate)
{
...
// 0x695650
void CScreenWorld::SetActionPanelEnabled(BOOL bEnable)
{
    CUIPanel* pActionPanel = m_cUIManager.GetPanel(1);
...
// 0x453780
BOOL CScreenWorld::IsInterfaceAutoHidden()
{
    return m_nAutoUnhideInterface > 0;
}

// 0x453790
void CScreenWorld::SetInterfaceAutoHide(BOOL bEnabled)
{
    if (bEnabled) {
