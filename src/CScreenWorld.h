...
public:
    ...
    void SetActionPanelsActive(BOOL bActive, BOOL bInvalidate);
    void SetBottomBarEnabled(BOOL bEnable);
    ...
    /* 015A */ int nm_m_field_15A;
    /* 015C */ unsigned char bm_m_field_15C;
    /* 015D */ unsigned char bm_m_field_15D;
    /* 015E */ short wm_m_field_15E;
    /* 0160 */ unsigned char bm_m_field_160;
    /* 0162 */ short wm_m_field_162;
    /* 0164 */ int nm_m_field_164;
    /* 0168 */ CVidFont pm_field_168;
    ...
    /* 0F37 */ unsigned char bm_field_F37;
    /* 0F3C */ INT m_nTopContainerRow;
    /* 0F40 */ INT m_nTopGroupRow;
    /* 0F44 */ unsigned char bm_field_F44;
    /* 0F46 */ CWeather m_weather;
    /* 10AE */ LONG m_scrollLockId;
    /* 10B2 */ short wm_m_field_10B2;
    /* 10B4 */ int nm_m_field_10B4;
    /* 10B8 */ LONG m_interactionIndex;
    /* 10BC */ LONG m_interactionTarget;
    /* 10C0 */ CString sm_m_field_10C0;
    /* 10C4 */ int nm_m_field_10C4;
    /* 10C8 */ int nm_m_field_10C8;
    /* 10CC */ int nm_m_field_10CC;
    /* 10D0 */ LONG nm_m_field_10D0;
    /* 10D4 */ BOOLEAN m_bSetNightOnActivate;
    /* 10D5 */ BOOLEAN m_bSetDayOnActivate;
    /* 10D6 */ BOOL m_ambianceForce;
    /* 10D8 */ int nm_m_field_10D8;
    ...
    /* 10F0 */ int nm_m_field_10F0;
    /* 10F4 */ int nm_m_field_10F4;
    /* 10F8 */ LONG m_autoPauseId;
    /* 10FC */ STRREF m_autoPauseRef;
    /* 1100 */ COLORREF m_autoPauseColor;
    /* 1104 */ STRREF m_autoPauseName;
    /* 1108 */ int nm_m_field_1108;
    /* 110C */ int nm_m_field_110C;
    /* 1138 */ INT m_nPickPartyNumCharacters;
    /* 114C */ int nm_m_field_114C;
    /* 1150 */ unsigned char bm_m_field_1150;
    ...
    /* 11B6 */ int nm_m_field_11B6;
    /* 11BA */ DWORD nm_m_field_11BA;
    /* 11BE */ int nm_m_field_11BE;
    /* 11C2 */ LONG m_lastAmbiance;
    /* 11C6 */ INT m_comingOutOfDialog;
    /* 11CA */ BYTE m_nAutoHideInterface;
    /* 11CC */ INT m_nAutoUnhideInterface;
    /* 11D0 */ CRect pm_m_field_11D0;
    /* 11F0 */ int nm_m_field_11F0;
    /* 11F4 */ int nm_m_field_11F4;
    /* 11F8 */ int nm_m_field_11F8;
    /* 1200 */ LONG m_nBlackOutCountDown;
    /* 1204 */ unsigned char bm_m_field_1204;
};
