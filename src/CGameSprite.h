...
public:
    ...
    BOOLEAN CheckWeaponUsability(BOOL a1);
    SHORT GetCriticalHitBonus();
    SHORT GetDamageTypeACMod(CGameSprite* target, CItem* curWeapon, const ITEM_ABILITY* curAttack);
    SHORT GetRacialAttackPenalty();
    SHORT GetRacialTargetBonus(CGameSprite* target);
    SHORT GetHalflingSlingBonus(CItem* curWeapon, const ITEM_ABILITY* curAttack);
    SHORT GetFlankingBonus();
    SHORT GetWeaponStyleBonus(CItem* curWeapon, const ITEM_ABILITY* curAttack);
    SHORT GetAbilityHitBonus(CItem* curWeapon, const ITEM_ABILITY* curAttack);
