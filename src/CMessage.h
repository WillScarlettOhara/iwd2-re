...
public:
    ...
    /* 009A */ CCriticalSection m_csPlayerRemoval;
...
public:
    ...
    /* 0060 */ int nfield_60;
    /* 0064 */ short m_nArmorClass;
    /* 0066 */ short m_nACDexBonus;
    /* 0068 */ short m_nACDodgeBonus;
    /* 006A */ short m_nACDeflectionBonus;
    /* 006C */ SHORT m_nACCrushingMod;
    /* 006E */ SHORT m_nACMissileMod;
    /* 0070 */ SHORT m_nACPiercingMod;
    /* 0072 */ SHORT m_nACSlashingMod;
    /* 0074 */ short m_nPortraitIcons;
    /* 0076 */ LONG* m_pPortraitIcons;
