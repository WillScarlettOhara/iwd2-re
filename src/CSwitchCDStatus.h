...
public:
    ...
    /* 0000 */ int nm_field_0;
    /* 0004 */ int nm_field_4;
    /* 0008 */ CVidMosaic pm_field_8[4];
    /* 02D8 */ CVidMosaic pm_field_2D8;
    /* 038C */ CVidMosaic pm_field_38C;
    /* 0440 */ CVidMosaic pm_field_440;
    /* 04F4 */ CVidFont pm_field_4F4;
    /* 09F4 */ CVidFont pfield_9F4;
    /* 0EF4 */ BOOL m_bActivateEngine;
    /* 0EF8 */ CCriticalSection pfield_EF8;
};
