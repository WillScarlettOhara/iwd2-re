...
public:
    ...
    CGameObject* GetObjectWithType(CGameAIBase* caller, BYTE type, BOOL checkBackList) const;
    BOOL Equal(const CAIObjectType& type) const;
    CGameObject* GetObject(CGameAIBase* caller, BOOL checkBackList) const;
    BOOL GetAiLocation(CGameAIBase* caller, CPoint& pt, INT& nRadius) const;
    LONG FindObjectId(CGameAIBase* caller, BOOL checkBackList) const;
    CGameObject* GetObjectTypeChecked(CGameAIBase* caller, BYTE type, BOOL checkBackList) const;
    CGameObject* GetObjectFromId(CGameAIBase* caller, BOOL checkBackList) const;
    ...
    BOOL IsOverPoint(const CPoint& pt) const;
    BOOL IsOverRect(const CPoint& pt) const;
