...
public:
    ...
    /* 012C */ int nm_field_12C;
    /* 0130 */ int nm_field_130;
    /* 0134 */ int nm_field_134;
    /* 0138 */ int nm_field_138;
    /* 013C */ int nm_field_13C;
...
public:
    ...
    /* 01E0 */ int nm_field_1E0;
    /* 01E4 */ int nm_field_1E4;
    /* 01E8 */ int nm_field_1E8;
    /* 01EC */ int nm_field_1EC;
    ...
    /* 0290 */ CImmunitiesItemEquipList pm_field_290;
    /* 02AC */ CImmunitiesItemTypeEquipList pm_field_2AC;
    /* 02C8 */ CImmunitiesProjectile m_cBounceProjectile;
    /* 02E4 */ CImmunitiesEffect m_cBounceEffect;
    /* 03C8 */ CImmunitiesProjectile pm_field_3C8;
    /* 03E4 */ CImmunitiesProjectile pm_field_3E4;
    /* 0400 */ CImmunitiesProjectile pm_field_400;
    /* 041C */ CImmunitiesProjectile pm_field_41C;
    /* 0438 */ CImmunitiesItemEquipList m_cImmunitiesItemUse;
    /* 0454 */ CImmunitiesItemTypeEquipList m_cImmunitiesItemTypeUse;
    /* 04AC */ CPtrList pm_field_4AC;
    /* 0480 */ std::set<int> m_naturalImmunities;
    /* 04C8 */ CPtrList pm_field_4C8;
    /* 04E4 */ CPtrList pm_field_4E4;
    /* 0500 */ CPtrList pfield_500;
    /* 051C */ CPtrList pfield_51C;
    /* 0538 */ CPtrList pfield_538;
